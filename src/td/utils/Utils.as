package td.utils
{
	...
	public class Utils
	{
		...
		/**
		 * Instantiates 'cls' as ByteArray and returns it as XML.
		 * @param	cls
		 * @return
		 */
		public static function xmlFromByteArrayClass(cls: Class) : XML {
			var byteArray:ByteArray = new cls as ByteArray;
			var xml: XML = new XML(byteArray.readUTFBytes(byteArray.length)); // synchronous read!
			byteArray.clear();
			return xml;
		}
