package td.constants {
    ...
    public class Game {
         ...
         */
        public static const MONEY_DROP_MIN: int = 1;
        /**
         * Maximum amount of money gained from picked coin dropped from killed enemy
         */
        public static const MONEY_DROP_MAX: int = 3;
